...
# docker build -t soft_stats .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name soft_stats soft_stats
...
RUN sed -i 's/ruby\.ruby4\.0$/ruby/' bin/*
